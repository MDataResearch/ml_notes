...
& = (W^{[l]})^T \frac{\partial J}{\partial z^{[l + 1]}} \odot \sigma'(z^{[l]}) \\
...
\noindent \hspace{1cm} compute \(\delta^{[l]} = (W^{[l]})^T \delta^{[l + 1]} \odot \sigma'(z^{[l]}) = (W^{[l]})^T \delta^{[l + 1]} \odot (a^{[l]} \odot (1 - a^{[l]}))\)
