...
\noindent Batch Normalization speeds up learning. In practice, normalizing \(Z^{[l]}\) is done much more often and that is what Andrew Ng presents.
...
\[\overset{N}{Z}^{[l](i)} = \gamma Z^{[l](i)}_{norm} + \beta\]
