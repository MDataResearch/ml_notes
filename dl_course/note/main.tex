...
\noindent Notice that \(b_{x}, b_{y}, b_{h}, b_{w}\) should be the percentage (as decimals) of each divided grid.

\bigskip

\noindent One of the best advantages that makes the YOLO algorithm popular is that it has a great speed and a Conv net implementation. But it will have a problem when there are more than one objects in one divided grid.
