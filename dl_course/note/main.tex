...
\noindent Average pooling is taking the averages of the values of the matched region instead of taking the max values. Max pooling is used more often than average pooling in practice.
