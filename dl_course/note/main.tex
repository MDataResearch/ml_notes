...
\noindent In the previous YOLO example, a grid cell only detects one object. What if a grid cell wants to detect multiple objects? The idea of Anchor boxes helps us solve this issue.
